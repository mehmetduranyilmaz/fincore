...
void main() {
  test('creates an income and refreshes the transaction list', () async {
  ...
  test('exposes failure when persistence fails', () async {
    ...
    final state = container.read(createIncomeControllerProvider);

    expect(state.status, CreateIncomeStatus.failure);
